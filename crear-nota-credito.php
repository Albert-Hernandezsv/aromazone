  ...
  <section class="content-header">
    ...
    <h1>
      ...
      $tipoFacturaTexto = "";
        ...
        echo ("Nota de crédito para ".$tipoFacturaTexto);
      ?>
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="tipoDte" id="tipoDte" value="05" hidden>
                                ...
                                foreach ($productos as $producto) {
                                    echo '<!-- ENTRADA PARA EL PRODUCTO -->
                                            <div class="row" id="productosContainer">
                                                ...
                                                <div class="col-xl-3 col-xs-12">
                                                    Total a disminuir al total de item - colocar sin iva (si lleva iva se suma automaticamente) y si es gran contribuyente se calcula solo (ver en pdf)
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text" id="basic-addon1"><i class="fa fa-usd"></i></span>
                                                        </div>
